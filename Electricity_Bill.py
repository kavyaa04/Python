...
# SLAB:2)  51-100 units = 50
    ...
    amount+= (50 * Rate_1) + (total_consumption-50) * Rate_2
# SLAB:3)  100-200 units = 100
elif total_consumption<= slab_3:
    amount+= (50 * Rate_1) + (50 * Rate_2) + (total_consumption - 100) * Rate_3
# SLAB:4)  201-300 units = 100
elif total_consumption <= slab_4:
    amount+= (50 * Rate_1) + (50 * Rate_2) + (100 * Rate_3) + (total_consumption - 200) * Rate_4
# SLAB:5)  301-400 units = 100
elif total_consumption <= slab_5:
    amount+= (50 * Rate_1) + (50 * Rate_2) + (100 * Rate_3) + (100 * Rate_4) + (total_consumption - 300) * Rate_5
# SLAB:6)  401-800 units = 400
elif total_consumption <= slab_6:
    amount+= (50 * Rate_1) + (50 * Rate_2) + (100 * Rate_3) + (100 * Rate_4) + (100 * Rate_5) + (total_consumption-400) * Rate_6
#  SLAB:7) More than 800
else:   
    amount+= (50 * Rate_1) + (50 * Rate_2) + (100 * Rate_3) + (100 * Rate_4) + (100 * Rate_5) + (400 * Rate_6) + (total_consumption-800) * Rate_7
